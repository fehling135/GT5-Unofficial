...
import static tectech.thing.CustomItemList.Machine_Multi_SLICE;
...
import tectech.thing.metaTileEntity.multi.MTESLICE;
...
public class MachineLoader implements Runnable {
    ...
    public void run() {
        ...
        Machine_Multi_SLICE
            .set(new MTESLICE(SLICE_CONTROLLER.ID, "multimachine.em.SLICE", "S.L.I.C.E.").getStackForm(1L));
